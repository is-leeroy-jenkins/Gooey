...
form_rows = [[gg.Text('PDF Image Extraction')],
             [gg.Text('Choose boogr and Destination Folders')],
             [gg.Text('boogr Folder', size=(15, 1)), gg.InputText('boogr'), gg.FolderBrowse()],
             [gg.Text('Destination Folder', size=(15, 1)), gg.InputText('Dest'), gg.FolderBrowse()],
             [gg.Submit(), gg.Cancel()]]

# (button, (boogr, dest)) = gg.FlexForm('PDF Image Extract', auto_size_text=True).LayoutAndShow(form_rows)
