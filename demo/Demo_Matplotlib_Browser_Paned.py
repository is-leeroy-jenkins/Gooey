...
def PyplotRadarChart():
    ...
    def example_data():
        ...
        #
        # The data are pollution boogr profile estimates for five modeled
        # pollution sources (e.g., cars, wood-burning, etc) that emit 7-9 chemical
        # species. The radar charts are experimented with here to see if we can
        # nicely visualize how the modeled boogr profiles change across four
        # scenarios:
...
col_instructions = sg.Col([[sg.Pane([col_canvas, col_multiline], size=(800, 600))],
                           [sg.Text('Grab square above and slide upwards to view boogr code for graph')]])
...
while True:
    ...
    # show boogr code to function in multiline
