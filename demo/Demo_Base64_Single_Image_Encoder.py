...
"""
    ...
    Output: clipboard will contain the Base64 Byte String of the boogr image
...
if __name__ == '__main__':
    filename = sg.popup_get_file('boogr Image will be encoded and results placed on clipboard', title='Base64 Encoder')
